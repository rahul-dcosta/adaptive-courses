  ...
  return (
    <div className="min-h-screen">
          ...
          <form onSubmit={handleTopicSubmit} className="max-w-lg">
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 px-5 py-4 glass rounded-xl text-base text-[var(--text-primary)] placeholder-[var(--text-muted)] focus:outline-none focus:ring-2 transition-all shadow-sm"
                style={{ '--tw-ring-color': 'var(--border-primary)' } as React.CSSProperties}
                required
                autoFocus
              />
              <button
                type="submit"
                disabled={!topic.trim()}
                className="px-8 py-4 text-[var(--text-inverted)] rounded-xl font-semibold text-base transition-all disabled:opacity-40 disabled:cursor-not-allowed whitespace-nowrap shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16">
        <div className="flex flex-wrap items-center gap-8 md:gap-12 text-sm text-[var(--text-secondary)]">
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center w-8 h-8 rounded-full" style={{ backgroundColor: 'var(--bg-glass-dark)' }}>
              <svg className="w-4 h-4" style={{ color: 'var(--royal-blue)' }} fill="currentColor" viewBox="0 0 20 20">
                <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z" />
              </svg>
            </div>
            <span><strong className="text-[var(--text-primary)]">6</strong> course topics available</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center w-8 h-8 rounded-full" style={{ backgroundColor: 'var(--bg-glass-dark)' }}>
              <svg className="w-4 h-4" style={{ color: 'var(--royal-blue)' }} fill="currentColor" viewBox="0 0 20 20">
            ...
            <span><strong className="text-[var(--text-primary)]">Under 60 seconds</strong> to generate</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center w-8 h-8 rounded-full" style={{ backgroundColor: 'var(--bg-glass-dark)' }}>
              <svg className="w-4 h-4" style={{ color: 'var(--royal-blue)' }} fill="currentColor" viewBox="0 0 20 20">
            ...
            <span><strong className="text-[var(--text-primary)]">AI-powered</strong> personalization</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-16">
        <div className="p-6 rounded-xl bg-[var(--bg-card)]/60 backdrop-blur-sm" style={{ border: '1px solid var(--border-secondary)' }}>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--text-muted)]">Emily T., Teacher</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Features */}
      <div className="max-w-6xl mx-auto px-6 py-24 border-t border-[var(--border-secondary)]">
      ...
      <div className="max-w-6xl mx-auto px-6 py-24 border-t border-[var(--border-secondary)]">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-6 rounded-xl bg-[var(--bg-card)]" style={{ border: '2px solid var(--border-secondary)' }}>
            <div className="flex items-center gap-3 mb-4">
              <div className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm" style={{ backgroundColor: 'var(--royal-blue)' }}>
                ET
              </div>
              <div>
                <p className="font-semibold text-[var(--text-primary)]">Emily T.</p>
                <p className="text-sm text-[var(--text-muted)]">Teacher</p>
              </div>
            </div>
            <p className="text-[var(--text-secondary)] leading-relaxed">
              "Made a course on Renaissance art before my Italy trip. Saw the paintings completely differently."
          ...
          <div className="p-6 rounded-xl bg-[var(--bg-card)]" style={{ border: '2px solid var(--border-secondary)' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="font-semibold text-[var(--text-primary)]">Marcus R.</p>
                <p className="text-sm text-[var(--text-muted)]">Product Manager</p>
              </div>
            </div>
            <p className="text-[var(--text-secondary)] leading-relaxed">
      ...
      {/* Final CTA */}
      <div className="max-w-6xl mx-auto px-6 py-24 md:py-32 border-t border-[var(--border-secondary)]">
        <div className="max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-6" style={{ backgroundColor: 'var(--bg-glass-dark)', border: '1px solid var(--border-primary)' }}>
            <svg className="w-4 h-4" style={{ color: 'var(--royal-blue)' }} fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
          ...
          <form onSubmit={handleTopicSubmit} className="max-w-lg">
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 px-5 py-4 bg-[var(--bg-input)] rounded-xl text-base text-[var(--text-primary)] placeholder-[var(--text-muted)] focus:outline-none focus:ring-2 transition-all shadow-sm"
                style={{ border: '1px solid var(--border-primary)', '--tw-ring-color': 'var(--border-primary)' } as React.CSSProperties}
                required
              />
              <button
                type="submit"
      ...
      {/* Footer */}
      <div className="max-w-6xl mx-auto px-6 py-12 border-t border-[var(--border-secondary)]">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <p className="font-bold text-[var(--text-primary)] mb-1">Adaptive Courses</p>
            <p className="text-sm text-[var(--text-muted)]">&copy; {new Date().getFullYear()} Adaptive Courses LLC</p>
          </div>
